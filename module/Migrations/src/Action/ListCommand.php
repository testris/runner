...
class ListCommand
{
    ...
    public function handle()
    {
        ...
        foreach ($iterator as $item) {
            ...
            $className = 'Data\\Migrations\\' . $matches[1];
            ...
            if (!$reflectionClass->isSubclassOf(\Migrations\AbstractVersion::class)) {
                throw new \RuntimeException("Version must be instanceof Data\Migrations\AbstractVersion");
            }
            $classes->append([
                'version' => $matches[2],
                'class' => $className,
