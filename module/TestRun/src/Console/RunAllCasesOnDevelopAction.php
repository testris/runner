...
class RunAllCasesOnDevelopAction extends Command
{
    /**
     * @var InputInterface
     */
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $testRun = $this->createAction->handle([], [
            'title' => 'Nightly develop build ' . date("j M, Y"),
            'environment' => Environment::TYPE_MTEST,
            'branch' => 'develop',
            'caseIds' => $casesIds
        ]);
    ...
    {
        $this
            ->setName('run:all-develop')
            ->setDescription("Run all cases on develop");
    }
